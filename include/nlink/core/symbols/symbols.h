...
// NexusSymbol, NexusSymbolTable, NexusSymbolRegistry are defined in types.h

#ifdef __cplusplus
extern "C" {
#endif

// Extended symbol type enumeration used internally by the symbol subsystem.
// NexusSymbolType in types.h covers the common subset; this enum adds
// language-level detail (class, interface, namespace, etc.).
typedef enum {
    SYMBOL_FUNCTION,
    SYMBOL_VARIABLE,
    SYMBOL_TYPE,
